...
```{r}
out3  <- system.file("extdata/vignettes_data", "pvalues_genetic.RData", package = "ARIpermutation")
alpha = 0.1
```
...
out3  <- system.file("extdata/vignettes_data", "TD_permutation_genetic.RData", package = "ARIpermutation")
