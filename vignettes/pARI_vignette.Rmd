...
*pARI* returns the lower bound for the true discovery proportion for each set of features. We can say that we have at least $1.53\%$ of truly active features in the first cluster.
