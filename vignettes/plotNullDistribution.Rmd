...
```{r}
ARIpermutation::plotNullDistribution(family = NULL,alpha = alpha, P = P,B = B)
```

We add the Simes critical values:

```{r}
ARIpermutation::plotNullDistribution(family = "simes", alpha = alpha, P = P,B = B, delta = delta)
```

```{r}
ARIpermutation::plotNullDistribution(family = "finner", alpha = alpha, P = P,B = B, delta = delta)
```
