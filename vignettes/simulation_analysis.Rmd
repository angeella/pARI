...
```{r}
out  <- load(system.file("extdata/vignettes_data", "out.RData", package = "ARIpermutation"))
...
Bperm  <- load(system.file("extdata/vignettes_data", "Bperm.RData", package = "ARIpermutation"))
