...
pi0 <- 0.8 #Proportion of true null hypotheses
...
#out1 <- sapply(c(1:length(rhos)), function(x) simEC(m = m,rho = rhos[x],n = n,pi0 = pi0,SNR = SNR,B=B),simplify = FALSE)
...
id <- 15
p <- sort(Pvalues[,id])
#idx <- sort(Pvalues[,id], index.return= TRUE)$ix
